...
train95523 = Train('95523', 50., Position(trs[5], 60.), sns[6])
trains = [train93341, train95523]
env1.set_trains(trains)

# add the train to the passing train of the station
for ele in stations:
    ele.find_trains()
stations[0].set_passing_train(train93341, 0.)
stations[0].state = 'ST'
stations[1].set_passing_train(train95523, 0.)
stations[1].state = 'ST'
